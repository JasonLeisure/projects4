...
function AttendForm() {
    let spinnerClasses="d-flex justify-content-center mb-3 spinner-div";
    ...
    if(conferences.length>0){
        spinnerClasses = "d-flex justify-content-center mb-3 spinner-div d-none"
                ...
                <div className="row">
                  <div className="col">
                    <div className="form-floating mb-3">
                      <input onChange={handleNameChange} value={name} required placeholder="Your full name" type="text" id="name" name="name"
                  ...
                  <div className="col">
                    <div className="form-floating mb-3">
                      <input onChange={handleEmailChange} value-={email}required placeholder="Your email address" type="email" id="email" name="email"
                        className="form-control" />
